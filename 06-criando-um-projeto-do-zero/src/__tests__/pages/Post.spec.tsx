...
import { GetStaticPropsContext, GetStaticPathsContext, GetStaticPathsResult } from 'next';
...
describe('Post', () => {
    beforeAll(() => {
        ...
        mockedPrismic.mockReturnValue({
            ...
            queryFirst: () => {
                return Promise.resolve(mockedQueryFirstReturn);
            }
        });
    });
    ...
    it('should be able to return prismic posts documents paths using getStaticPaths', async () => {
        ...
        const response = (await getStaticPaths(getStaticPathsContext)) as GetStaticPathsResult;
